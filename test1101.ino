...
int a[18] = {2,4,5,12,13,14,15,18,19,21,22,23,25,26,32,33,34,35};
// Helper macro to calculate array size
#define COUNT_OF(x) ((sizeof(x)/sizeof(0[x])) / ((size_t)(!(sizeof(x) % sizeof(0[x])))))

// WiFi access point
#define WIFI_AP_NAME        "free"
// WiFi password
#define WIFI_PASSWORD       "freefree"
...
/*
  ...
  return RPC_Response("data", active);
}
